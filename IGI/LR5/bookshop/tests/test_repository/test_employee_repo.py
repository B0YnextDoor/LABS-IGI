...
class EmployeeRepositoryTest(TestCase):
    ...
    def test_get_all(self):
        empls = EmployeeRepository.get_all()
    ...
    def test_get_by_id(self):
        empl = EmployeeRepository.get_by_id(1)
    ...
    def test_get_by_email(self):
        empl = EmployeeRepository.get_by_email('test@employee.com')
        self.assertIsNotNone(empl)
        self.assertEquals(empl.name, 'Test Employee')
        self.assertEquals(empl.phone, '+375291111111')
        self.assertEquals(empl.email, 'test@employee.com')
    ...
    def test_update(self):
        empl = EmployeeRepository.update(
    ...
    def test_get_info(self):
        has_info, no_info = EmployeeRepository.get_info()
    ...
    def test_add_info(self):
        info = EmployeeRepository.add_info(2, '/img1.png', 'aboba')
    ...
    def test_update_info(self):
        user = EmployeeRepository.update_info(1, 'imgw.png', 'Text')
