...
from app.views import authView, mainView, infoView, bookView, \
    ...
    vacancyView, reviewView, contactView, cartView, sandboxView, bannerView
...
urlpatterns = [
    ...
    # banner
    path('banner/', bannerView.BannerView.as_view(), name='banner'),

    # cart
    path('cart/', cartView.CartView.as_view(), name='cart'),

    # sandbox
    path('sandbox/', sandboxView.SandBoxView.as_view(), name='sandbox'),
    path('cubes/', mainView.cubeCalculator, name='cubes')
]
