...
class AccountView(View):
    ...
    def get(self, request):
        ...
        return render(request, self.template_name, {'role': role, 'user': user_info, 'form': None, 'cart': request.session.get('cart')})
    ...
    def post(self, request):
        ...
        if (request.POST.get('action') == 'editMe'):
            ...
            return render(request, self.template_name, {'role': role, 'user': user_info, 'form': form, 'cart': request.session.get('cart')})
